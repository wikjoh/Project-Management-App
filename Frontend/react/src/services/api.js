...
export const getCustomersDetailed = () => api.get('/customers/detailed');
...
export const getServicesDetailed = () => api.get('/services/detailed');
...
export const getProjectStatusesDetailed = () => api.get('/project-statuses/detailed');
...
export const getRolesDetailed = () => api.get('/roles/detailed');
export const getRole = (id) => api.get(`/roles/id/${id}`);
export const createRole = (data) => api.post('/roles', data);
export const updateRole = (data) => api.put(`/roles`, data);
export const deleteRole = (data) => api.delete(`/roles`, { data });
...
export const getServiceUnitsDetailed = () => api.get('/service-units/detailed');
